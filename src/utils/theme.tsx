...
export const getDesignTokens = (mode: 'light' | 'dark') => {
  ...
  return {
    ...
    palette: {
      ...
      background: {
        default: getColor('#f8f9fa', '#151519'),
        navbar: getColor('#FF5B00', '#FF5B00'),
        header: getColor('#f8f9fa', '#151519'),
        paper: getColor('#ffffff', '#302D2A'),
        surface: getColor('#f4f5f7', '#2A2826'),
        disabled: getColor('#EAEBEF', '#EBEBEF14'),
      },
      divider: getColor('#e9ecef', '#EBEBEF14'),
      action: {
        active: getColor('#62677B', '#EBEBEF8F'),
