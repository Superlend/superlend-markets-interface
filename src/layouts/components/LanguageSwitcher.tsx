  ...
  return (
    <Box component={component} onClick={onClick} sx={{ color: { xs: 'text.primary' } }}>
      ...
      <Box sx={{ display: 'flex', alignItems: 'center' }}>
        ...
        <SvgIcon fontSize="small" sx={{ color: { xs: 'text.primary' }, ml: 1 }}>
          <ChevronRightIcon />
        </SvgIcon>
      </Box>
    </Box>
...
export const LanguagesList = ({ component = ListItem, onClick }: LanguageListItemProps) => {
  ...
  return (
    <>
      <Box
        component={component}
        sx={{ color: { xs: 'text.primary' }, mb: '4px' }}
        onClick={onClick}
      >
        <ListItemIcon
          sx={{
      ...
      {Object.keys(langMap).map((lang) => (
        ...
        >
          ...
          {lang === i18n.locale && (
            <ListItemIcon sx={{ m: 0 }}>
              <SvgIcon fontSize="small" sx={{ color: { xs: 'text.primary' } }}>
                <CheckIcon />
              </SvgIcon>
            </ListItemIcon>
          )}
