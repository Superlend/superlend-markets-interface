    ...
    switch (blockingError) {
      ...
      case ErrorType.V3_HF_TOO_LOW:
        return (
          <>
            <Trans>
              This action will reduce health factor of Superlend Protocol below liquidation
              threshold. Increase migrated collateral or reduce migrated borrow to continue.
            </Trans>
          </>
        );
      default:
