      ...
      >
        ...
        <Typography>
          <Trans>
            ...
            or <Link href="https://github.com/Plenty-network/plend-core-contracts">Github</Link>.
          </Trans>
        </Typography>

        <Button
          variant="outlined"
          onClick={() => navigator.clipboard.writeText(txError.rawError?.message?.toString() || 'Unknown error')}
          size="small"
          sx={{ mt: 6 }}
        >
